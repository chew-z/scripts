...
#property link      "Export_Matlab_02"
...
int start() {
  ...
  if(handle < 1)    {
     ...
     FileWrite(handle, "#","DATETIME", "iDay","OPEN","HIGH","LOW", "CLOSE", "Costf L", "6-Stochatic Main", 
     "7-Stochatic Signal", "8-RSI", "9-ADX 5", "10-ADX 14", "11-HC_D1", "12-LC_D1", "13-HH_D1", "14-LL_D1", "15-MA_D1", "16-lookBackDays4", "17-dV","18-isT_L_D1", "19-isT_S_D1");
     for(int i=bars_count-1; i>=0; i--) {
       ...
       FileWrite(handle, i+1,t,iDay, Open[i],High[i], Low[i], Close[i], costf(i), stoch_main, stoch_sign, rsi, adx5, adx14, HC_D1, LC_D1, HH_D1, LL_D1, MA_D1, lookBackDays, deltaVol, isTL, isTS );
